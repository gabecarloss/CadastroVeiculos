...
🧱 POO Modelagem com classe Veiculo
🔒 Encapsulamento Proteção de dados
📦 ArrayList Manipulação dinâmica de dados
...
📁 src 
├── Main.java # Lógica principal e fluxo do sistema
└── Veiculo.java # Modelo de dados (entidade)
----------------------------------------------------------------------------------------------------------------------------------
👨‍💻 ✦ Autor:
